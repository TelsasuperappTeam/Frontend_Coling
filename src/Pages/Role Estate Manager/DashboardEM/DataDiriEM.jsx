...
export default function DataDiriEM({
  onClose,
  onSave,
  initialData,
  lockedFields,
    ...
    if (initialData) {
      ...
      if (initialData.koordinat_lahan) {
        try {
          ...
          // Handle format object {x, y} atau {latitude, longitude} atau string
  ...
  // --- LOGIKA GEOLOCATION (GPS OTOMATIS) ---
  ...
  return (
    <div className="bg-white rounded-3xl overflow-hidden shadow-2xl relative flex flex-col max-h-[90vh] w-full">
      ...
      <div className="p-6 overflow-y-auto space-y-8 bg-gray-50/50">
        ...
        {/* 3. BAGIAN KOORDINAT (SESUAI REQUEST) */}
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative flex-grow">
              ...
              <input
                ...
                // Jika diklik: Request Location (jika tidak terkunci), atau tampilkan warning (jika terkunci)
                onClick={() =>
